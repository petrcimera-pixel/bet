    ...
    for p in predictions:
        ...
        if goal_lines:
            ...
            gp = {
                ...
                "odds": sel.get("best_odds"),
                "book": sel.get("best_book", ""),
        ...
        if corner_lines:
            ...
            cp = {
                ...
                "odds": csel.get("best_odds"),
                "book": csel.get("best_book", ""),
        ...
        tip = {
            ...
            "pick_odds":    pick_bet.get("best_odds"),
            "pick_book":    pick_bet.get("best_book", ""),
            ...
            "value_odds":   bv.get("best_odds") if bv.get("is_value") else None,
            "value_ev":     round(bv.get("ev", 0) * 100, 1) if bv.get("is_value") else None,
            "value_book":   bv.get("best_book", "") if bv.get("is_value") else None,
